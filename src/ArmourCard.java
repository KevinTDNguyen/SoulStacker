public class ArmourCard extends Card{ // extends will allow us to use the methods created in the Card class
    ...
    public ArmourCard(String name, int rank, String gameClass ,int stat, String type){
        super(name, rank, gameClass ,stat, type); // super basically inherits the constructor variables of the Card class all in one go (which reduces clutter)
