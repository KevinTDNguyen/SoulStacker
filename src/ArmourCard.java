public class ArmourCard extends Card{ // extends will allow us to use the methods created in the Card class
    ...
    public ArmourCard(String name, int rank, int stat, String type, String description){
        super(name, rank, stat, type, description); // super basically inherits the constructor variables of the Card class all in one go (which reduces clutter)
